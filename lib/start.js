...
var getFreePort = require('get-port');
        ...
        function onReady(serverPort){
            ...
            setTimeout(function(){
                newChromeBrowser({wdPort: wdPort, hosts: hosts, wdPacUrl: wdPacUrl, isRecorder: true, debug: debug}, function*(browser){
                    ...
                    yield browser.url('chrome-extension://'+(debug?'dloihppejiolohmfmhdceaikmmfmmemf':'njkfhfdkecbpjlnfmminhmdcakopmcnc')+'/'+(mobile?'mobile':'start')+'.html?port='+serverPort);
        ...
        function saveTestFile(){
            if(allCaseCount > 0){
                ...
                if(raw){
                    ...
                    console.log("do you want to get derivative case?");
                }
                if(isConfigEdited){
